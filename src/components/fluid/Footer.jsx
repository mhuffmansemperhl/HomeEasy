                            ...
                            <div className={styles["upper-footer-content-left-links-container"]}>
                                <div className={styles["upper-footer-content-left-links"]}>
                                    <div className={styles["upper-footer-content-left-links-item"]}>
                                        ...
                                        <div className={styles["upper-footer-content-left-links-link"]}> <a className='underline-on-hover-red' onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_1_sell_pricing", ()=>{router.push(`/calculator-1`);}]);}}>Pricing</a> </div>
                                    </div>
                                    <div className={styles["upper-footer-content-left-links-item"]}>
                            ...
                            <div className={styles["upper-footer-content-left-links-container"]}>
                                ...
                                <div className={styles["upper-footer-content-left-links"]}>
                                    <div className={styles["upper-footer-content-left-links-item"]}>
                                        ...
                                        <div className={styles["upper-footer-content-left-links-link"]}> <a className='underline-on-hover-red' onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_1_calc_net_proceeds", ()=>{router.push(`/calculator-1`);}]);}}>Net proceeds</a> </div>
                                        <div className={styles["upper-footer-content-left-links-link"]}> <a className='underline-on-hover-red' onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_1_calc_he_savings", ()=>{router.push(`/calculator-2`);}]);}}>HomeEasy savings</a> </div>
                                        <div className={styles["upper-footer-content-left-links-link"]}> <a className='underline-on-hover-red' onClick={(e) => {e.preventDefault(); gtmPush(["callback", "foot_1_calc_est_mnt_pmts", ()=>{router.push(`/calculator-3`);}]);}}>Est. monthly payments</a> </div>
                                    </div>
                                    ...
                                    <div className={styles["upper-footer-content-left-links-item"]}>
                                        ...
                                        <div className={styles["upper-footer-content-left-links-link"]}> <a className='underline-on-hover-red1' href='https://play.google.com/store/apps/details?id=com.simplenexus.loans.client.s__111612' target='_blank'><img src="/img/google (1).png" alt="google" /></a> </div>
                                        <div className={styles["upper-footer-content-left-links-link"]}> <a className='underline-on-hover-red1' href='https://apps.apple.com/us/app/homeeasymortgage/id1543249109' target='_blank'><img src="/img/google (2).png" alt="apple" /></a> </div>
                                    </div>
                                </div>
                            </div>
...
<p>HomeEasy Homes is an affiliate company of Semper Home Loans, Inc. </p>
