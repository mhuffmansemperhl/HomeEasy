...
const Questions = ({question_title, question_copy, question_questions, question_show_link, question_index}) => {
    ...
    useEffect(() => {
        ...
        if(question_index) {
            setSelectedQuestionsTabIndex(question_index);
        }
    }, []);
    ...
    function toggleQuestion(index) {
        ...
        // if(index === 0) {
        doEventClick({"event_name": `quest_exp_${parseInt(index) + 1}`});
        // }
        // if(index === 1) {
        //     doEventClick({"event_name": "home_quest_exp_2"});
        // }
        // if(index === 2) {
        //     doEventClick({"event_name": "home_quest_exp_3"});
        // }
        // if(index === 3) {
        //     doEventClick({"event_name": "home_quest_exp_4"});
        // }
                ...
                <div className={`${styles['main-component-content-container']} centered-content`}>
                    ...
                    <div className={styles['advantage-content-item-get-started-link']}>
                        ...
                        callback={()=>{
                            ...
                            gtmPush(["callback", "read_more_faqs", ()=>{router.push(`/questions`);}]);
