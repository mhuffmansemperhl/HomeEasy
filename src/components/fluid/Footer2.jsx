                ...
                languages: {
                    en: {
                        consent_modal: {
                            ...
                            description:
                                'This website uses essential cookies to ensure its proper operation and tracking cookies to understand how you interact with it. <button type="button" data-cc="c-settings" class="cc-link">Let me choose</button>',
                            primary_btn: {
                                text: "Accept all",
                ...
                <div className={styles["lower-footer"]}>
                                ...
                                <div className={styles["lower-footer-content-right-social-links-container"]}>
                                    ...
                                    <a
                                        ...
                                        onClick={(e) => {
                                            ...
                                            gtmPush([
                                                ...
                                                "foot_2_social_insta",
                                                () => {
                                                    router.push(`https://www.instagram.com/semperhl/`);
                                                },
                                            ]);
                                        }}
                                    >
                                    ...
                                    <a
                                        ...
                                        onClick={(e) => {
                                            ...
                                            gtmPush([
                                                ...
                                                "foot_2_social_fb",
                                                () => {
                                                    router.push(`https://www.facebook.com/semperhl`);
                                                },
                                            ]);
                                        }}
                                    >
                                    ...
                                    <a
                                        ...
                                        onClick={(e) => {
                                            ...
                                            gtmPush([
                                                "callback",
                                                "foot_2_social_twitter",
                                                () => {
                                                    router.push(`https://twitter.com/SemperHL`);
                                                },
                                            ]);
                                        }}
                                    >
                    ...
                    <div className={`${styles["bottom_footer_text"]} centered-content2`}>
                        ...
                        <div className={styles["grand_text"]}>
                            1 The following offers are available only to clients who are purchasing a home and financing with HomeEasy Mortgage: (1) Client purchasing with a HomeEasy Homes Partner Agent through HomeEasy Homes will receive a
