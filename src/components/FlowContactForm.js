    ...
    return (
        <div className={`${styles['main-component']}`}>
            <div className={`${styles['main-content-container']}  centered-content`} >
                ...
                <div className={`${styles['contact-form-disclaimer-container']}`}>By clicking Continue, I agree to HomeEasy Home’s <a href="">Terms of Use</a> , <a href="">Privacy Policy</a> , and the <a href="">Affiliated Business Disclosure and Privacy Notice</a> and I agree that HomeEasy Homes and its affiliated companies may contact me via phone or text, including by automated means. I understand that standard message/data rates may apply. HomeEasy Homes does not sell customer data.</div>
            </div>
        </div>
    )
};
