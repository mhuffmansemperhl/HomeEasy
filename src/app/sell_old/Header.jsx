         ...
         { !google_api_loaded && <GooglePlacesScript />}
            ...
            <div className={`${styles['main-content-container']} centered-content`}>
                <div className={`${styles['header-content-container']}`}>
                    <div className={styles['header-content-title']}>Sell your home, the <span>easy way.</span></div>
                    <div className={styles['header-content-copy']}>Sell your home with HomeEasy.</div>
