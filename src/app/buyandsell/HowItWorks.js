      ...
      <div className={`${styles["main-content-container"]}  centered-content2`}>
        ...
        <div className={`${styles["content-container"]}`}>
          ...
          <div className={`${styles["main-copy-container"]}`}>
            ...
            Simplifying your life is our priority. Choose between an InstantOffer or list with us
for just 1%<sup>2</sup> – whatever suits you best, we’ll make it happen!.{" "}
            </div>

            <div className={`${styles["main-copy-copy-title"]}`}>Step 2</div>
            <div className={`${styles["main-copy-copy"]}`}>
            Get a same day pre-approval with our Preferred Lender for low interest rates and
same day pre-approval
            </div>

            <div className={`${styles["main-copy-copy-title"]}`}>Step 3</div>
            <div className={`${styles["main-copy-copy"]}`}>
            Discover a home you love, make an offer, negotiate, inspect, and appraise – all with
your agent right by your side
            </div>

            <div className={`${styles["main-copy-copy-title"]}`}>Step 4</div>
            <div className={`${styles["main-copy-copy"]}`}>
            Sold & offer accepted! Save thousands, pop the champagne and get packing! Plus
receive a lender paid credit of 1.50%1 of your financed loan amount up to $10,000
