          ...
          <div className={styles["header-content-ul"]}>
            <div className={styles["header-content-inner"]}>
                ...
                <div className={styles["header-content-text"]}>
                 <span className={styles["only_mobile"]}>01</span> Get pre-approved with our Preferred Lender
                </div>
            ...
            <div className={styles["header-content-round"]} >
                ...
                <div className={styles["header-content-text"]}>
                <span className={styles["only_mobile"]}>02</span>  Get matched with a Preferred Agent and find your dream home!
                </div>
