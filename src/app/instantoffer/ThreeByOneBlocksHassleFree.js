            ...
            <div className={`${styles['main-content-container']}  centered-content2`}>
                ...
                <div className={`${styles['items']}`}>
                     ...
                     <div className={`${styles['item']}`}>
                        ...
                        <div className={`${styles['item-copy-container']}`}>Let our market specialists handle it all!
Your home value is carefully evaluated by
our expert real estate partners who
specialize in your local market.</div>
                    </div>
                    
                    <div className={`${styles['item']}`}>
                        <div className={`${styles['item-title-container']}`}>Save money.</div>
                        <div className={`${styles['item-copy-container']}`}>Keep thousands in your pocket! Pay no
realtor fees. Pay no closing costs. Make
no repairs. Get fast cash. Don’t like our
offer? No worries, you can still <a href=""> list for
less </a></div>
                    ...
                    <div className={`${styles['item']}`}>
                        ...
                        <div className={`${styles['item-copy-container']}`}>Expedite the process significantly with an
instant cash offer. Simple, stress-free,
and quick – we’ll have it all wrapped up
in just 15 days**</div>
<div className={`${styles['item-foot-container']}`}>
                            <ArrowButton
                                small_text={true}
